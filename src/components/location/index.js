      ...
      <section className="section-directions">
        <div className="columns is-gapless">
          <div className="column">
            ...
            <a class="button is-primary is-medium" href="https://www.google.com/maps/d/u/0/edit?mid=16NHT3mtm38k9nDk3RwA9XbkyXP6V2dUz&usp=sharing" target="_blank">Get Directions</a>
          </div>
          <div className="column">
            <figure class="image is-5by4">
              <img className="has-ratio" src="assets/hotel.jpg" alt="bottleworkshotel"/>
            </figure>
            <a class="button is-white is-medium" href="https://reservations.travelclick.com/112191?groupID=3269574" target="_blank">Book a Room</a>
          </div>
        </div>
      </section>
    </div>
